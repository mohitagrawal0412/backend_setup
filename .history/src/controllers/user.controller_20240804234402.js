...
// aggaregate fucntion to get number of subscriber and total channel substribed
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(200, channel[0], "User channel profile fetched successfully");
});
export {
  registerUser,
  loginInUser,
